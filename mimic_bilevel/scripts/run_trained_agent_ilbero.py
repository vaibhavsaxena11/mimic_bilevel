...
Example usage:
    ...
    python scripts/run_trained_agent_ilbero.py --agent='/Users/vaibhav/work/imitate-behavior/mimic_bilevel/trained_models_mimicplay/libero/test/20231125132753/models/model_epoch_1000.pth' \
        --bddl_file='/Users/vaibhav/work/robomimicV2/LIBERO/libero/libero/bddl_files/libero_90/KITCHEN_SCENE1_open_the_bottom_drawer_of_the_cabinet.bddl' \
        --video_path='./vid.mp4'

    python scripts/run_trained_agent_ilbero.py --agent='/Users/vaibhav/work/imitate-behavior/mimic_bilevel/trained_models_mimicplay/libero/test/20231125132753/models/model_epoch_3000.pth' \
        --bddl_file='/Users/vaibhav/work/robomimicV2/LIBERO/libero/libero/bddl_files/libero_90/KITCHEN_SCENE1_open_the_bottom_drawer_of_the_cabinet.bddl' \
        --video_path='./vid.mp4'

    python scripts/run_trained_agent_ilbero.py --agent='/Users/vaibhav/work/imitate-behavior/mimic_bilevel/trained_models_mimicplay/libero/test/20231125132753/models/model_epoch_3000.pth' \
        --bddl_file='/Users/vaibhav/work/robomimicV2/LIBERO/libero/libero/bddl_files/libero_90/KITCHEN_SCENE3_turn_on_the_stove.bddl' \
        --video_path='./vid.mp4'
...
import robomimic
import mimic_bilevel.utils.file_utils as FileUtils
...
def run_trained_agent(args):
    ...
    ckpt_dict["env_metadata"]["env_name"] = "Libero_Kitchen_Tabletop_Manipulation"
    # TODO get env_name from bddl_file; hard-coded for now
    # parsed_problem = BDDLUtils.robosuite_parse_problem(args.bddl_file)
    # ckpt_dict["env_metadata"]["env_name"] = TODO(parsed_problem['problem_name']) # 'libero_kitchen_tabletop_manipulation'
    # import pdb; pdb.set_trace()
